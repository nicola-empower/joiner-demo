    ...
    return (
        <div className="space-y-6 pb-20">
            ...
            <div className="bg-gray-800 p-4 rounded-xl space-y-4">
                <h3 className="text-lg font-bold text-[#D97706] mb-2">Your Figures</h3>
                <div>
                    ...
                    <input
                        ...
                        className="w-full p-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-[#D97706] focus:border-[#D97706]"
                    />
                </div>
                ...
                <div className="flex items-center gap-3 pt-2">
                    <input
                        ...
                        className="h-5 w-5 rounded bg-gray-700 border-gray-600 text-[#D97706] focus:ring-[#D97706]"
                    />
            ...
            <div className="bg-gray-800 p-4 rounded-xl">
                <h3 className="text-lg font-bold text-[#D97706] mb-4">Estimated Take-Home</h3>

                <div className="mb-4 p-4 bg-gray-700/50 rounded-xl border border-[#D97706]/30 text-center">
                    <span className="text-xs font-medium text-[#D97706]">Annual Net Income</span>
