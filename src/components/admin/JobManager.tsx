            ...
            <div className="flex flex-col md:flex-row justify-between gap-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                <div className="relative flex-1">
                    ...
                    <input 
                        ...
                        className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#D97706] focus:border-transparent outline-none"
                    />
                </div>
                ...
                <button 
                    ...
                    className="flex items-center gap-2 bg-[#D97706] text-white px-4 py-2 rounded-lg hover:bg-[#78350F] transition-colors shadow-sm font-medium"
                >
